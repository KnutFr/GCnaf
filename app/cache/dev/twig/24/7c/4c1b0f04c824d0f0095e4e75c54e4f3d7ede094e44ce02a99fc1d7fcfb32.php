...
class __TwigTemplate_247c4c1b0f04c824d0f0095e4e75c54e4f3d7ede094e44ce02a99fc1d7fcfb32 extends Twig_Template
{
    ...
    {
        // line 3
        $context["__internal_f463b4f6e7e951a4b5fe47dc2f788fa59ebc557d3093fe1b45b37a6fdc38aa08"] = $this;
        // line 5
...
";
    ...
    ";
        // line 80
        echo $context["__internal_f463b4f6e7e951a4b5fe47dc2f788fa59ebc557d3093fe1b45b37a6fdc38aa08"]->getdisplay_timeline(("timeline_" . $this->getContext($context, "token")), $this->getAttribute($this->getContext($context, "collector"), "events"), $this->getContext($context, "colors"));
        echo "
    ...
    ";
        ...
        if (twig_length_filter($this->env, $this->getAttribute($this->getContext($context, "profile"), "children"))) {
            ...
            ";
                // line 90
                echo $context["__internal_f463b4f6e7e951a4b5fe47dc2f788fa59ebc557d3093fe1b45b37a6fdc38aa08"]->getdisplay_timeline(("timeline_" . $this->getAttribute($this->getContext($context, "child"), "token")), $this->getContext($context, "events"), $this->getContext($context, "colors"));
                echo "
        ";
            }
...
";
        // line 406
        echo $context["__internal_f463b4f6e7e951a4b5fe47dc2f788fa59ebc557d3093fe1b45b37a6fdc38aa08"]->getdump_request_data($this->getContext($context, "token"), $this->getContext($context, "profile"), $this->getAttribute($this->getContext($context, "collector"), "events"), $this->getAttribute($this->getAttribute($this->getAttribute($this->getContext($context, "collector"), "events"), "__section__"), "origin"));
        echo "
...
";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["child"]) {
                // line 411
                echo $context["__internal_f463b4f6e7e951a4b5fe47dc2f788fa59ebc557d3093fe1b45b37a6fdc38aa08"]->getdump_request_data($this->getAttribute($this->getContext($context, "child"), "token"), $this->getContext($context, "child"), $this->getAttribute($this->getAttribute($this->getContext($context, "child"), "getcollector", array(0 => "time"), "method"), "events"), $this->getAttribute($this->getAttribute($this->getAttribute($this->getContext($context, "collector"), "events"), "__section__"), "origin"));
...
";
    ...
    public function getdump_request_data($_token = null, $_profile = null, $_events = null, $_origin = null)
    {
        ...
        try {
            // line 451
            $context["__internal_f97f0f2496ec54059dc9074d0edfb44d21dfd5e8faceb0012680e9421683db6a"] = $this;
            // line 452
            echo "                {
                    \"id\": \"";
            // line 453
...
";
            // line 456
            echo $context["__internal_f97f0f2496ec54059dc9074d0edfb44d21dfd5e8faceb0012680e9421683db6a"]->getdump_events($this->getContext($context, "events"));
            echo "
                    ]
                }
";
